...
if [[ ! -z ${lastAvailDate} ]] && [[ ${lastAvailDate} != ${lastDlDate} ]]; then
    ...
    rsync -aur ${HERE}/jpg taimaz@68.183.206.70:/mnt/data/models/Currents/HYCOM/
    ...
    # mv ${HERE}/nc/HYCOM_Currents_avgDepth_${date}*.nc ${HERE}/nc/HYCOM_Currents_avgDepth_avgTime.nc ${pathPlanning}/forecast/
    mv ${HERE}/nc/HYCOM_Currents_avgDepth_*.nc ${pathPlanning}/forecast/
