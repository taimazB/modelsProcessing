...
function regrid {
    ...
    case=$1
    if [[ ${case} -eq 1 ]]; then
	cdo -P 32 -O sellevel,0 ${HERE}/nc/${field}_${model}_${lastDlDate}.nc ${HERE}/nc/${field}_${model}_${lastDlDate}_surface.nc
	cdo -P 32 -s -O remapbil,${HERE}/scripts/grid.txt ${HERE}/nc/${field}_${model}_${lastDlDate}_surface.nc ${HERE}/nc/${field}_${model}_${lastDlDate}_surface_regrid.nc
    elif [[ ${case} -eq 2 ]]; then
	cdo -P 32 -O sellevel,25,50,75,100,150,200 ${HERE}/nc/${field}_${model}_${lastDlDate}.nc ${HERE}/nc/${field}_${model}_${lastDlDate}_0020-0200_allLevels.nc
	cdo -P 32 -O vertmean ${HERE}/nc/${field}_${model}_${lastDlDate}_0020-0200_allLevels.nc ${HERE}/nc/${field}_${model}_${lastDlDate}_0020-0200.nc
	cdo -P 32 -s -O remapbil,${HERE}/scripts/grid.txt ${HERE}/nc/${field}_${model}_${lastDlDate}_0020-0200.nc ${HERE}/nc/${field}_${model}_${lastDlDate}_0020-0200_regrid.nc
    elif [[ ${case} -eq 3 ]]; then
	cdo -P 32 -O sellevel,50,75,100,150,200,250,300,500,1000 ${HERE}/nc/${field}_${model}_${lastDlDate}.nc ${HERE}/nc/${field}_${model}_${lastDlDate}_0050-1000_allLevels.nc
	cdo -P 32 -O vertmean ${HERE}/nc/${field}_${model}_${lastDlDate}_0050-1000_allLevels.nc ${HERE}/nc/${field}_${model}_${lastDlDate}_0050-1000.nc
	cdo -P 32 -s -O remapbil,${HERE}/scripts/grid.txt ${HERE}/nc/${field}_${model}_${lastDlDate}_0050-1000.nc ${HERE}/nc/${field}_${model}_${lastDlDate}_0050-1000_regrid.nc
    fi
}
export -f regrid
...
##  Extract u,v
ncks -v u,v ${ncDir}/NorKyst-800m_ZDEPTHS_his.fc.${lastDlDate}00.nc ${HERE}/nc/${field}_${model}_${lastDlDate}.nc
