...
export HERE=${HOME}/Projects/mapBoxData/Seaice/CMC
...
if [[ -n ${lastAvailDate} ]]  &&  [[ ${lastAvailDate} != ${lastDlDate} ]]; then
    ...
    # mv ${HERE}/png/*.png /media/taimaz/f74aa447-fe2f-44af-8ee6-3bb554756a5d/taimaz/CMC/Seaice/png/
...
# EOF
    # rsync -aurz ${HERE}/jpg taimaz@159.203.6.104:/mnt/external/models/Seaice/CMC/ &
